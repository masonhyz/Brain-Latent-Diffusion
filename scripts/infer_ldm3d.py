"""
PairedLatentDiffusion (3D LDM) inference.

Usage:
    python scripts/infer_ldm3d.py --ckpt runs/ldm3d/stage2_best.pt \\
...
def visualize(x_pre, x_post_real, x_post_pred, loss_val: float, save_path: str):
    ...
    fig.suptitle(f"LDM3D prediction  |  masked-L1 = {loss_val:.4f}", fontsize=13)
    plt.tight_layout()
...
def main():
    ...
    p.add_argument("--out",            default="ldm3d_prediction.png")
